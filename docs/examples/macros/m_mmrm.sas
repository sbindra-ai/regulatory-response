%MACRO m_mmrm(datain, byvar, classvar, yvar, xvar,repstr, lsmeans, estim,pred)
 ...
 * Comments         :
 *******************************************************************************
 * Author(s)        : emybb (Kaisa Laapas) / date: 23OCT2023
 *******************************************************************************
 * Change History   :
 ******************************************************************************/
    ...
    %if "%upcase(&repstr)"="UN" %then %do;
       * ods listing close;
        ...
        PROC MIXED data=&datain;
            ...
            ODS OUTPUT LSMeans=&lsmeans Estimates=&estim ConvergenceStatus=convstatus ;
        RUN;
        QUIT;
