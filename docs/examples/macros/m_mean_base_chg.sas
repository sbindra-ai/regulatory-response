 ...
 * Change History   :
 ******************************************************************************/
/* Changed by       : emvsx (Phani Tata) / date: 01AUG2023
 * Reason           : updated the header
 ******************************************************************************/
/* Changed by       : emvsx (Phani Tata) / date: 29NOV2023
 * Updated where condition to use   and ANL04FL = "Y"
...
OPTIONS NONOTES NOSOURCE NOFMTERR missing = " " ;
*----------------------------------*;
...
/*proc sort data = &ads. nodupkey ;*/
/*        by PARAMCD   TRT01PN     SUBJID avisitn ;*/
/*RUN;*/
