 ...
 * Comments         :
 *******************************************************************************
 * Author(s)        : egavb (Reema S Pawar) / date: 23OCT2023
 * Reference prog   : /var/swan/root/bhc/3427080/21652/stat/main01/val/analysis/pgms/l_10_2_6_1_3spqs.sas (egavb (Reema S Pawar) / date: 13JUN2023)
 ******************************************************************************/
...
DATA QS;
    SET sp.qs;
     ...
     WHERE QSCAT = 'MENOPAUSE-SPECIFIC QUALITY-OF-LIFE QUESTIONNAIRE (MENQOL)';
...
%LET label ='MENOPAUSE-SPECIFIC QUALITY-OF-LIFE QUESTIONNAIRE (MENQOL)';
