...
# *******************************************************************************
#  *Name of program**************************************************************/
#    %iniprog(name = i_8_2_1_13_sup1_r.r);
#  /*
#  * Purpose          : Create table of confirmatory testing results for first supplementary estimand
#  * Programming Spec :
...
################################################################################  
#PARAMETER:
#         pvalue: pvalues for first supplementary estimand
################################################################################
...
p.values0 <- read_sas("p_val_sup1.sas7bdat")
p.values0
...
if(rej1==TRUE){
 ...
 rej2 <- rej1 & p.values[2]<=alpha1
  ...
  i_8_2_1_13_gmcp_sup1 <- cbind(alpha, p.values, rej)
  write.csv(i_8_2_1_13_gmcp_sup1,  "i_8_2_1_13_gmcp_sup1.csv"  )
