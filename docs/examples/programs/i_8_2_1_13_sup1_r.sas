 ...
 *******************************************************************************
 *Name of program**************************************************************/
   %iniprog(name = i_8_2_1_13_sup1_r );
/*
 ...
 * Reference prog   : /var/swan/root/bhc/3427080/21652/stat/main01/val/analysis/pgms/i_8_2_1_13_sup1_r.sas (gfsdv (Ulrike Krahn) / date: 12SEP2023)
 ******************************************************************************/
...
%let tfldata = p_val_sup1 ;

%*< 1: Define some helper variables;
DATA  p_val_sup1 ;
    set tlfmeta.p_val_sup1;
RUN;


%LET mainR     =  %str(i_8_2_1_13_sup1_r.r);
...
%zip(zipfile = &zipFile., dataset = tlfmeta.p_val_sup1 );
...
%unzip(zipFile = &outFile., file = work/i_8_2_1_13_gmcp_sup1.csv   , to = &outdir./tlfmeta, junkPath = Y)

data i_8_2_1_13_gmcp_sup1   ;
           %let _EFIERR_ = 0; /* set the ERROR detection macro variable */
           infile "&outdir/tlfmeta/i_8_2_1_13_gmcp_sup1.csv" delimiter = ',' MISSOVER DSD lrecl=32767 firstobs=2 ;
           informat VAR1 $4. ;
           informat alpha $20. ;
...
data tlfmeta.i_8_2_1_13_gmcp_sup1 ;
    set i_8_2_1_13_gmcp_sup1  ;
    length eff_var $2000.;
