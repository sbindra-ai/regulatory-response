 ...
 *******************************************************************************
 *Name of program**************************************************************/
   %iniprog(name = f_8_2_3_2_adqs_vas_l   );
/*
 * Purpose          : Box plot of change from baseline in MENQOL
 *                     Vasomotor  score by treatment group (FAS)
 * Programming Spec : 
 ...
 * Reference prog   : /var/swan/root/bhc/3427080/21652/stat/main01/val/analysis/pgms/f_8_2_3_2_adqs_vas_l.sas (emvsx (Phani Tata) / date: 20OCT2023)
 ******************************************************************************/
...
%m_f_line_plot( param1 = %str(MENB995) ,
