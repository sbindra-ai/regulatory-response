 ...
 *******************************************************************************
 *Name of program**************************************************************/
   %iniprog(name = if_8_2_1_2_3_shf_sp2 );
/*
 * Purpose          : Second supplementary estimand change from baseline in mean daily severity of moderate to severe hot flashes
 ...
 * Reference prog   : /var/swan/root/bhc/3427080/21652/stat/main01/val/analysis/pgms/if_8_2_1_2_3_shf_sp2.sas
 ******************************************************************************/
...
%m_mmrm_rubin (estim  , LSMEAN , shf_sup2);
