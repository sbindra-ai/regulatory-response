 ...
 *******************************************************************************
 *Name of program**************************************************************/
   %iniprog(name = t_adqs_hrtprs_elg);
/*
 ...
 * Reference prog   : /var/swan/root/bhc/3427080/21651/stat/query15/dev/pgms/t_adqs_hrtprs_elg.sas (eaikp (Ajay  Sharma) / date: 16OCT2024)
 ******************************************************************************/
...
ods escapechar="^";
%set_titles_footnotes(tit1 = "Table: Participants eligibility for HRT based on the primary and secondary conditions &fas_label."
                      );
%desc_freq_tab(
    data     = final
  , var      = avalc_
