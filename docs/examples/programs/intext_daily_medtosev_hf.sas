 ...
 *******************************************************************************
 *Name of program**************************************************************/
   %iniprog(name = intext_daily_medtosev_hf);
/*
 * Purpose          : Generate intext table for mean change in daily severity of mod to sev HF from
 ...
 * Reference prog   : /var/swan/root/bhc/3427080/21652/stat/main01/dev/analysis/pgms/intext_daily_medtosev_hf.sas (ggqct (Jose Diaz) / date: 23OCT2023)
 ******************************************************************************/

data elmean;
    set tlfmeta.t_8_2_1_2_1_hfss_shf_s_1;
...
data elpdiff ;
    set tlfmeta.t_8_2_1_2_1_hfss_shf_p_1;
    where avisitn in (10,40,120)  and  _nwtrt = 1;
    _difind = 2;
    format _difind;
    keep avisitn _difind _trt_txt _v_2_1 _v_2_2 _v_2_3 _v_2_4;
...
data data3;
    set tlfmeta.if_8_2_1_2_1_shf_1;
    where ~missing(COL1) ;
    if _orderN = 4 then avisitn = 40;
    else if _orderN = 10 then avisitn = 120;
    _orderN + 50;
    _difind = 2;
    format _difind;
...
%let enum_src1 = %intext_get_enumeration(meta_file = tlfmeta.t_8_2_1_2_1_hfss_shf_s_1);
%let enum_src2 = %intext_get_enumeration(meta_file = tlfmeta.t_8_2_1_2_1_hfss_shf_p_1);



title1 "Table: Mean change in daily severity of moderate to severe HF from baseline to Week 12 &fas_label";

footnote1 "Source: &enum_src1., &enum_src2., Table 8.2.1.5 / 3";
