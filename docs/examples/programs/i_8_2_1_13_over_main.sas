 ...
 *******************************************************************************
 *Name of program**************************************************************/
   %iniprog(name = i_8_2_1_13_over_main );
/*
 ...
 * Reference prog   : /var/swan/root/bhc/3427080/21652/stat/main01/val/analysis/pgms/i_8_2_1_13_over_main.sas (sgtja (Katrin Roth) / date: 07JUL2023)
 ******************************************************************************/
;

%let tfldata = i_8_2_1_13_gmcp ;
...
%set_titles_footnotes(
        tit1 = Table: Overview of testing of statistical hypotheses
