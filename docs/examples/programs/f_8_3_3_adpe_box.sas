 ...
 * Reference prog   : /var/swan/root/bhc/3427080/21652/stat/main01/val/analysis/pgms/f_8_3_3_adpe_box.sas (emvsx (Phani Tata) / date: 24AUG2023)
 ******************************************************************************/
...
%load_ads_dat(advs_view,
              adsDomain = advs ,
              where =anl01fl = "Y"
                     and   paramcd in (   'WEIGHT' 'HIPCIR' 'WSTCIR'  )
