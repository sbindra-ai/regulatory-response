 ...
 *******************************************************************************
 *Name of program**************************************************************/
   %iniprog(name = i_8_2_1_13_main_r );
/*
 ...
 * Reference prog   : /var/swan/root/bhc/3427080/21652/stat/main01/val/analysis/pgms/i_8_2_1_13_main_r.sas (gfsdv (Ulrike Krahn) / date: 07SEP2023)
 ******************************************************************************/
...
%let tfldata = p_val_main ;


DATA  p_val_main ;
    set tlfmeta.p_val_main;
RUN;


%LET mainR     =  %str(i_8_2_1_13_main_r.r);
...
%zip(zipfile = &zipFile., dataset = tlfmeta.p_val_main );
...
%unzip(zipFile = &outFile., file = work/i_8_2_1_13_gmcp.csv   , to = &outdir./tlfmeta, junkPath = Y)

data WORK.I_8_2_1_13_GMCP    ;
           %let _EFIERR_ = 0; /* set the ERROR detection macro variable */
           infile "&outdir/tlfmeta/i_8_2_1_13_gmcp.csv" delimiter = ',' MISSOVER DSD lrecl=32767 firstobs=2 ;
           informat VAR1 $4. ;
           informat alpha $20. ;
