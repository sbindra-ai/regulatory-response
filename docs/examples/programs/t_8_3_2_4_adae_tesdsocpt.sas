 ...
 *******************************************************************************
 *Name of program**************************************************************/
   %iniprog(name = t_8_3_2_4_adae_tesdsocpt, log2file = Y);
/*
 * Purpose          : Treatment-emergent study drug-related serious adverse events: number of subjects by primary system organ class and preferred term  (SAF)
 * Programming Spec : 
 ...
 * Reference prog   : /var/swan/root/bhc/3427080/21652/stat/main01/dev/analysis/pgms/t_8_3_2_4_adae_tesdsocpt.sas (enpjp (Prashant Patel) / date: 09SEP2023)
 ******************************************************************************/
