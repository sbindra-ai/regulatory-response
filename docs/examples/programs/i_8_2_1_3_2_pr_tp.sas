 ...
 *******************************************************************************
 *Name of program**************************************************************/
   %iniprog(name = i_8_2_1_3_2_pr_tp  );
/*
 * Purpose          : Tipping point analysis for change from baseline in PROMIS SD SF 8b total T-score -
 *                     MMRM analysis <<at Week 12>> (FAS)t Week 1>>
 * Programming Spec :
 ...
 * Reference prog   : /var/swan/root/bhc/3427080/21652/stat/main01/val/analysis/pgms/i_8_2_1_3_2_pr_tp.sas (sgtja (Katrin Roth) / date: 03JUL2023)
 ******************************************************************************/
/* Changed by       : sgtja (Katrin Roth) / date: 20DEC2023
 * Reason           : extended number of steps to 10
 ******************************************************************************/
...
*start with 0 (=original analysis), go in steps of 3 until probt_1 in estim_tot is >0.025;
...
%m_tp(datain=step3, delta=12)
%m_tp(datain=step3, delta=15)
%m_tp(datain=step3, delta=18)
%m_tp(datain=step3, delta=21)
%m_tp(datain=step3, delta=24)
%m_tp(datain=step3, delta=27)
%m_tp(datain=step3, delta=30)

OPTIONS NOMPRINT;

data __estim_tp_all;
    length col1 col2 col3 col4   $100.  week $20. ;
    set estim_tot_0 estim_tot_3 estim_tot_6 estim_tot_9 estim_tot_12 estim_tot_15
        estim_tot_18 estim_tot_21 estim_tot_24 estim_tot_27 estim_tot_30;
    by scenario;
    col1 = Strip(scenario) ;
