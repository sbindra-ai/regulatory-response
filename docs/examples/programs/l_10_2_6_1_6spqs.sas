 ...
 * Reference prog   : /var/swan/root/bhc/3427080/21652/stat/main01/val/analysis/pgms/l_10_2_6_1_6spqs.sas (egavb (Reema S Pawar) / date: 13JUN2023)
 ******************************************************************************/
...
PROC SORT DATA = adsl (KEEP = &subj_var SASR &treat_var_listings_part. &treat_var. );    BY &subj_var ;RUN;
...
%LET label ='European Quality of Life 5-dimension 5-level questionnaire';
