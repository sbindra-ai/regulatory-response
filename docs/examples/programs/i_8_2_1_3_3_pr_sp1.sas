 ...
 * Reference prog   : /var/swan/root/bhc/3427080/21652/stat/main01/val/analysis/pgms/i_8_2_1_3_3_pr_sp1.sas (gltsh (Bohdana Ratitch) / date: 15OCT2023)
 ******************************************************************************/
...
%let valsuf=_sup1_promis;


data adqs;
    set ads.adqs;
    where trim(parcat1)="PROMIS SLEEP DISTURBANCE SHORT FORM 8B V1.0" and
          paramcd="PSDSB999" and
...
%m_mmrm_rubin (estim  , LSMEAN , pr_sup1 );
