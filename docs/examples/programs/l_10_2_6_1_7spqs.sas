 ...
 * Reference prog   : /var/swan/root/bhc/3427080/21652/stat/main01/val/analysis/pgms/l_10_2_6_1_7spqs.sas (egavb (Reema S Pawar) / date: 13JUN2023)
 ******************************************************************************/
...
DATA QS;
    SET sp.qs;
     ...
     WHERE QSCAT = "BECK DEPRESSION INVENTORY - II (BDI-II)" ;
...
%LET label ='BECK DEPRESSION INVENTORY (BDI)';
