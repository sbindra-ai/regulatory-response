 ...
 * Reference prog   : /var/swan/root/bhc/3427080/21652/stat/main01/val/analysis/pgms/l_10_2_6_1_4spqs.sas (egavb (Reema S Pawar) / date: 13JUN2023)
 ******************************************************************************/
...
DATA QS;
    SET sp.qs;
     ...
     WHERE QSCAT = "PATIENT GLOBAL IMPRESSION VASOMOTOR SYMPTOMS V1.0"
          AND QSSCAT= "VASOMOTOR SYMPTOMS-SEVERITY OF MODERATE TO SEVERE HOT FLASHES" ;
...
%LET label ='Patient Global Impression of Severity (PGI-S)';
*<*****************************************************************************;
*< create listing                                                              ;
*<*****************************************************************************;
