 ...
 * Reason           : #drafting table for condition1#
 ******************************************************************************/
...
DATA adqs;
    ...
    BY studyid usubjid;
    IF inadsl AND inqs;
    IF paramcd IN("HMB132" "HMB102" "HMB101" "HMB133" "HMB123" "HMB108" "HMB109" "HMB110" "HMB111" "HMB112" "HMB113" "HMB114");
    FORMAT paramcd;
RUN;

data adqs1;
        set adqs;
        where (paramcd eq "HMB102" and avalc eq "CHECKED") or
...
RUN;
ods escapechar="^";
%set_titles_footnotes(tit1 = "Table: History of menopause hormone therapy-condition-1 &fas_label.",
                    ftn1 ="^&super_a participant meet the following conditions:",
                    ftn2 ="1) Never received HT due to existence of contra-indications according to label OR",
