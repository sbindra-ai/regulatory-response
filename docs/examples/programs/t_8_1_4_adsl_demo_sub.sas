 ...
 *******************************************************************************
 *Name of program**************************************************************/
   %iniprog(name = t_8_1_4_adsl_demo_sub);
/*
 ...
 * Comments         :
 *******************************************************************************
 * Author(s)        : enpjp (Prashant Patel) / date: 15NOV2023
...
%mend;
/*Region*/
%demog (pop_cond1=&fas_cond,subset=%str(region1n),pop_label1=by region &fas_label, trtused=&treat_arm_p.);
/*Race*/
%demog (pop_cond1=&fas_cond,subset=%str(racen),pop_label1=by race &fas_label, trtused=&treat_arm_p.);
/*Ethnicity*/
%demog (pop_cond1=&fas_cond,subset=%str(ethnicn),pop_label1=by Ethnicity &fas_label, trtused=&treat_arm_p.);
/*Smoking History*/
%demog (pop_cond1=&fas_cond,subset=%str(smokhxn),pop_label1=by Smoking History &fas_label, trtused=&treat_arm_p.);
/*BMI Group*/
%demog (pop_cond1=&fas_cond,subset=%str(bmigr1n),pop_label1=by BMI &fas_label, trtused=&treat_arm_p.);
