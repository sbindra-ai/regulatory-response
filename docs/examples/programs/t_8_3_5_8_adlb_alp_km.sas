 ...
 *******************************************************************************
 *Name of program**************************************************************/
   %iniprog(name = t_8_3_5_8_adlb_alp_km );
/*
 * Purpose          : Cumulative incidence for  ALP  >=3xULN by treatment group: Descriptive statistics (SAF)
 * Programming Spec :
 ...
 * Reference prog   : /var/swan/root/bhc/3427080/21652/stat/main01/val/analysis/pgms/t_8_3_5_8_adlb_alp_km.sas (emvsx (Phani Tata) / date: 15NOV2023)
 ******************************************************************************/
